...
if USE_PRETRAINED:
    try:
      net.load_state_dict(torch.load(os.path.join(CHECKPOINT_PATH, '2019-10-29_20:19:17.ckpt')))
      print("Loaded weights from checkpoint: {}".format('2019-10-29_20:19:17.ckpt'))
    except:
      print("Checkpoint not found: {}".format('2019-10-29_20:19:17.ckpt'))
